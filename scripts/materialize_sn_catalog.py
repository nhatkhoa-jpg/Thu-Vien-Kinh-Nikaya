...
def materialize() -> tuple[list[dict], dict]:
    ...
    for ref in refs:
        ...
        if ref in old_sn:
            ...
            # Preserve editorial identity/content while aligning canonical source/display metadata.
    ...
    # Canonical refs, ids, and slugs must all be unique in the final catalog.
    final = non_sn + rows
